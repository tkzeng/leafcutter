...
server <- function(input, output, session) {
  ...
  output$all_clusters <- DT::renderDataTable({
    datatable( clusters[,c("gene","coord","N","annotation")],
              escape = FALSE,
              rownames = FALSE,
              colnames = c('Genomic location'='coord','Gene'='gene','N'='N','Annotation'='annotation'),
              selection = 'single', 
